...
Node convert<stereo_detector_alterno::CannyConfig>::encode(const stereo_detector_alterno::CannyConfig & config) {
	Node node;
...
bool convert<stereo_detector_alterno::CannyConfig>::decode(const Node & node, stereo_detector_alterno::CannyConfig & config) {
...
Node convert<stereo_detector_alterno::GaussConfig>::encode(const stereo_detector_alterno::GaussConfig & config) {
	Node node;
	node["apply"]         = config.apply ? "true" : "false";
...
bool convert<stereo_detector_alterno::GaussConfig>::decode(const Node & node, stereo_detector_alterno::GaussConfig & config) {
	config.apply          = node["apply"].as<bool>();
...
Node convert<stereo_detector_alterno::HoughConfig>::encode(const stereo_detector_alterno::HoughConfig & config) {
	Node node;
...
bool convert<stereo_detector_alterno::HoughConfig>::decode(const Node & node, stereo_detector_alterno::HoughConfig & config) {
...
Node convert<stereo_detector_alterno::Configuration>::encode(const stereo_detector_alterno::Configuration & config) {
	Node node;
...
bool convert<stereo_detector_alterno::Configuration>::decode(const Node & node, stereo_detector_alterno::Configuration & config) {
	config.pre_blur       = node["pre_gauss"].as<stereo_detector_alterno::GaussConfig>();
	config.edge_detection = node["canny"].as<stereo_detector_alterno::CannyConfig>();
	config.post_blur      = node["post_gauss"].as<stereo_detector_alterno::GaussConfig>();
	config.hough_config   = node["hough"].as<stereo_detector_alterno::HoughConfig>();
